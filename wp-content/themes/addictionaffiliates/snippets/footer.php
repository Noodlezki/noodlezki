    ...
    <div class="row">
      ...
      <h6><?= bloginfo(); ?></h6>
        ...
        <p class="footer-socials">
          ...
          <a href="https://www.twitter.com/recoveryguide1"><i class="fa fa-twitter fa-2x"></i></a>
          <a href="https://www.linkedin.com/in/recovery-guide-26b035137"><i class="fa fa-linkedin fa-2x"></i></a>
        </p>
